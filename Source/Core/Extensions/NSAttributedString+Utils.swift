...
public extension NSAttributedString {
  ...
  func textSize(width: CGFloat = .greatestFiniteMagnitude, height: CGFloat = .greatestFiniteMagnitude) -> CGSize {
    return textSizeWithSize(CGSize(width: width, height: height))
  }
  
  func textSizeWithSize(_ size: CGSize = CGSize(width: CGFloat.greatestFiniteMagnitude, height: CGFloat.greatestFiniteMagnitude)) -> CGSize {
